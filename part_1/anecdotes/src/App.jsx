...
const MostVoted = ({votes, anecdotes}) => {
  ...
  const maxIndex = votes.findIndex(number => number===maxVotes)
...
const App = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Button text = "Next anecdote" handler = {nextBtnHandler}/>
        <Button text = "Vote for this anecdote" handler = {voteBtnHandler}/>
      </div>
